...
public class Planet_Move2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            puzzle.Change_Planet2(true);
        }
        else if(collision.tag == "Point1" && collision.tag == "Point2" && collision.tag == "Point4")
        {
            puzzle.Change_Planet2(false);
        }
    }
}
